...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_entry = 15,                     /* entry  */
  YYSYMBOL_statement = 16,                 /* statement  */
  YYSYMBOL_query = 17,                     /* query  */
  YYSYMBOL_column_list = 18,               /* column_list  */
  YYSYMBOL_table_ref = 19,                 /* table_ref  */
  YYSYMBOL_opt_where = 20,                 /* opt_where  */
...
static const char *const yytname[] =
{
  ...
  "';'", "','", "$accept", "entry", "statement", "query", "column_list",
  "table_ref", "opt_where", "condition", "literal", YY_NULLPTR
};
...
{
      10,     5,     1,     8,    21,    22,     6,    12,    14,    11,
       9,    15,    24,    17,    19,     0,     0,    20
};

static const yytype_int8 yycheck[] =
{
       4,     6,     3,     0,     7,     8,    11,     6,     6,    13,
      12,     5,    20,     6,    10,    -1,    -1,     9
};
...
{
       0,     3,    15,    16,    17,     6,    11,    18,     0,    12,
       4,    13,     6,    19,     6,     5,    20,     6,    21,    10,
       9,     7,     8,    22,    21
};
...
#line 33 "grammars/mysql.y"
                     { }
#line 1095 "mysql.tab.c"
    break;

  case 4: /* query: SELECT column_list FROM table_ref opt_where  */
#line 37 "grammars/mysql.y"
                                                  { }
#line 1101 "mysql.tab.c"
    break;

  case 5: /* column_list: '*'  */
#line 41 "grammars/mysql.y"
                           { }
#line 1107 "mysql.tab.c"
    break;

  case 6: /* column_list: IDENTIFIER  */
#line 42 "grammars/mysql.y"
                           { }
#line 1113 "mysql.tab.c"
    break;

  case 7: /* column_list: column_list ',' IDENTIFIER  */
#line 43 "grammars/mysql.y"
                                 { }
#line 1119 "mysql.tab.c"
    break;

  case 8: /* table_ref: IDENTIFIER  */
#line 47 "grammars/mysql.y"
                           { }
#line 1125 "mysql.tab.c"
    break;

  case 9: /* opt_where: %empty  */
#line 51 "grammars/mysql.y"
                           { }
#line 1131 "mysql.tab.c"
    break;

  case 10: /* opt_where: WHERE condition  */
#line 52 "grammars/mysql.y"
                           { }
#line 1137 "mysql.tab.c"
    break;

  case 11: /* condition: IDENTIFIER COMPOP literal  */
#line 56 "grammars/mysql.y"
                                    { }
#line 1143 "mysql.tab.c"
    break;

  case 12: /* condition: condition LOGICOP condition  */
#line 57 "grammars/mysql.y"
                                    { }
#line 1149 "mysql.tab.c"
    break;

  case 13: /* literal: INTVAL  */
#line 61 "grammars/mysql.y"
                          { }
#line 1155 "mysql.tab.c"
    break;

  case 14: /* literal: STRINGVAL  */
#line 62 "grammars/mysql.y"
                          { }
#line 1161 "mysql.tab.c"
    break;
